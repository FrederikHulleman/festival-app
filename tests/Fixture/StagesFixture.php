...
class StagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'stages_ibfk_1' => ['type' => 'foreign', 'columns' => ['festival_id'], 'references' => ['festivals', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2020-01-16 11:42:38',
                'modified' => '2020-01-16 11:42:38',
            ],
        ];
        parent::init();
    }
