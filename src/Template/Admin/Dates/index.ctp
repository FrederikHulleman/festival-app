        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    ...
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $date->slug]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $date->slug], ['confirm' => __('Are you sure you want to delete # {0}?', $date->slug)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
