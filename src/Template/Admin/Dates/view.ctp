...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Date'), ['action' => 'edit', $date->slug]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Date'), ['action' => 'delete', $date->slug], ['confirm' => __('Are you sure you want to delete # {0}?', $date->slug)]) ?> </li>
